# Generated by Django 3.2.18 on 2024-11-05 03:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='Enter a ISBN', max_length=13, verbose_name='ISBN')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Enter a genre', to='catalog.Genre'),
        ),
    ]
